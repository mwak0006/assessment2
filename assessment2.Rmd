...
```{r scatterplot1, fig.cap="Scatter Plot of Mortality Rate Under 5 years and GNI Per Capita"}
df %>%
...
df %>%
  summarize(Mortality_U5_correlation = cor(GNIPerCapita, Mortality_U5_Total, use = "complete.obs"),
            LifeExp_correlation = cor(GNIPerCapita, LifeExp_Total, use = "complete.obs")
