...
The visualisations comprises two scatterplots that highlight the relationship between GNI Per Capita and the health indicators—mortality rates among children under 5 and life expectancy. The visualisations encompasses all OECD countries from 2000 to 2022.

The Figure \@ref(fig:scatterplot1) unveils a downward trend in Mortality rates, suggesting that as GNI Per Capita increases, there is a corresponding decline in infant mortality rates.
...
The Life Expectancy Correlations for these countries range from 0.661 to 0.928, indicating a strong positive association between GNI per capita and life expectancy. The higher correlations suggest a more significant impact of economic prosperity on increasing life expectancy.
...
```
In the next Table \@ref(tab:tableavg2) it examines the 10 Countries with lowest average GNI per Capita. The data suggests a negative relationship between GNI per Capita and Infant Mortality rates for these countries. As GNI per capita decreases, there is a tendency for infant mortality rates to increase. The negative correlations for these countries range from -0.813 to -0.980, indicating a strong negative association between lower GNI per capita and higher mortality rates. The stronger negative correlations suggest a more pronounced impact of economic challenges on child mortality.
